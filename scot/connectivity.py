...
class Connectivity(object):
    ...
    An overview of most supported measures can be found in [1]_.

    References
    ----------
    .. [1] M. Billinger, C. Brunner, G. R. Müller-Putz. Single-trial
    ...
    def sPDC(self):
        ...
        References
        ----------
        L. Astolfi, F. Cincotti, D. Mattia, M. G. Marciani, L. Baccala, F. D.
        ...
        IEEE Trans. Biomed. Eng. 53(9): 1802-1812, 2006.
        """
        return self.PDC()**2
